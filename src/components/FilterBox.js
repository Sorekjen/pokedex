...
function FilterBox({ callback }) {
  ...
  const [dropToggle, setDropToggle] = useState({gen: false, type: false, sort: false});
      ...
      <div className="filterbox">
        ...
        <div className="gen-drop" style={{ display: dropToggle?.gen ? "" : 'none' }}>
          <div className="gen-container">
            ...
            {[[1, "kanto (1)"], [2, "johto (2)"], [3, "Hoenn (3)"], [4, "sinnoh (4)"], [5, "unova (5)"], [6, "kalos (6)"], [7, "Alola (7)"], [8, "Galar (8)"], [9, "Paldea (9)"]].map((gen) => (
              <Button
                key={gen + 36}
                value={gen[0]}
                label={gen[1]}
